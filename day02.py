...
# b = 0j
# c = j7
# print(a, type(a), type(a.real), type(a.imag)) #(3+4j) <class  'class  'complex'> <class  'class 'float'> <class 'float'>
...
# print(l)             #set([4,5,6])
# print(m)             #set(['a', 'b', 'c'])
# print(n)             #set(['r', 'a', 'k', 'e', 's', 'h'])
# print(o)             #set([1, 2, 3, 4, 5])
